 ...
 * @author Vanessa
 */
public class reporteDevolucionSalida {
    ...
    public void getReporte(String ruta, String numSalida) throws ClassNotFoundException, ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        Connection conexion;
        ...
        parameter.put("numSalida", numSalida);
