 ...
 * @author Vanessa
 */
public class reporteDevolucionEntrada {
    ...
    public void getReporte(String ruta, String numDevol) throws ClassNotFoundException, ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        Connection conexion;
        ...
        parameter.put("numDevol", numDevol);
