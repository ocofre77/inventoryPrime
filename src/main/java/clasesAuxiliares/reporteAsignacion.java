...
public class reporteAsignacion {
    ...
    public void getReporte(String ruta,  String Num_salida) throws ClassNotFoundException, ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        Connection conexion;
        ...
        parameter.put("Num_salida", Num_salida);
