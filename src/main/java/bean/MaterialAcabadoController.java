...
public class MaterialAcabadoController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle(("Bundle")).getString("MaterialAcabadoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle(("Bundle")).getString("MaterialAcabadoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle(("Bundle")).getString("MaterialAcabadoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
