...
//metodos pra editar la cantidad del producto en la tabla
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle(("Bundle")ring("DevolucionesEntradasCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle(("Bundle")ring("DevolucionesEntradasUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle(("Bundle")ring("DevolucionesEntradasDeleted"));
        if (!JsfUtil.isValidationFailed()) {
