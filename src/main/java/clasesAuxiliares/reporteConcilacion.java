 ...
 * @author Vanessa
 */
public class reporteConcilacion {
    ...
    public void getReporte(String ruta, String Num_cotizacion) throws ClassNotFoundException, ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        Connection conexion;
        ...
        parameter.put("Num_cotizacion", Num_cotizacion);
