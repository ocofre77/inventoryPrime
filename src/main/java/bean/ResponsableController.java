...
import sesion.ResponsableFacade;
...
public class ResponsableController implements Serializable {
    ...
    @EJB
    private sesion.ResponsableFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("resource/Bundle").getString("ResponsableCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("resource/Bundle").getString("ResponsableUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("resource/Bundle").getString("ResponsableDeleted"));
        if (!JsfUtil.isValidationFailed()) {
