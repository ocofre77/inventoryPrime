...
public class HerramientaController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle(("Bundle")).getString("HerramientaCreated"));
    ...
    public void update() {
        cambiarFechaMan();
        persist(PersistAction.UPDATE, ResourceBundle.getBundle(("Bundle")).getString("HerramientaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle(("Bundle")).getString("HerramientaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
